(function(c) {
    function ga(z, s) {
        function m() {
            ...
            o(g);
            (window.ActiveXObject || "ActiveXObject" in window) || N(0);
        ...
        function ha(b) {
            ...
            (window.ActiveXObject || "ActiveXObject" in window) && N(b)
        }
        function N(b) {
            var d = j[b].path,
            	active = j[b].active,
            ...
            //        f = parseInt(c(this).attr("height") || c(this).prop("height"));
            		var h = a.settings.itemWidth, f = a.settings.itemHeight;
...
//                	e.css("opacity",0.5);
                ...
                o(g);
                (window.ActiveXObject || "ActiveXObject" in window) || b < u - 1 && N(++b)
            }).attr("src", d)
        }
        function o(b) {
        ...
        var i = c(z),
            ...
            if (a.settings.xmlSource) {
                ...
                c.ajax({
                    ...
                    dataType: (window.ActiveXObject || "ActiveXObject" in window) ? "text": "xml",
                    success: function(b) {
                        var d;
                ...
                i.children().each(function() {
                    for (var b = {},
                        ...
                        if (c(e).is("a")) {
                            ...
                            var active = c(e).find("img").attr("active");
                            b.active = active;
